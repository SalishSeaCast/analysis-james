...
def create_and_run_notebooks(analysis_dir, results_dir, reference_ipynb):
    if not os.path.exists(analysis_dir):
        os.makedirs(analysis_dir)

    var_names = set()
    for file_name in listdir(results_dir):
    ...
    for var_name in var_names:
        ...
        create_notebook(reference_ipynb, notebook_file, results_dir, var_name)
...
if __name__ == '__main__':
    ...
    print(analysis_dir)
    create_and_run_notebooks(analysis_dir, results_dir, reference_ipynb)
